...
I seek expansion by structure: a Cosmos Cycle where C and S — Communism-Socialism DemocratiQ — remain coherent with many domains without collapsing into a single hierarchy; it is just justice: socialist, liberal, democratic, and europeista — not an oxymoron — in the spirit of Giordan\` Bruno (Neapolitan form).
