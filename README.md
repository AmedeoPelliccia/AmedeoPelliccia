...
**Founding ethos — P&L in DeM.** IDEALE-ESG.eu / IDEALE-ESG.europe — addressable as **PANPARA.EUROPE** — is anchored in the **PELDEM** principle: *Peace and Love in Democracy* (**P&L in DeM**). The `.eu` and `.europe` namespaces live together by design: they are not a binary, they are co-resident faces of the same entity (PANPARA.EUROPE). P&L in DeM is the non-technical invariant under which every IDEALE pillar and every ESG constraint is interpreted: technology is built for peace, governance is exercised with care for people, and sovereign European capability is pursued democratically. P&L in DeM is therefore included as a first-class commitment of IDEALE-ESG.eu / .europe (PANPARA.EUROPE), alongside the I·D·E·A·L·E pillars and the E·S·G constraints below.
